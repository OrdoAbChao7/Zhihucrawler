...
class CollectionDownloader:
    ...
    def download_items(self, items: list[dict[str, Any]], output_dir: Path, emit) -> int:
        ...
        for item in items:
            ...
            # ⚡ Bolt: Use short-circuit evaluation to lazily evaluate `_content_preview(item)`.
            # This prevents unnecessary CPU overhead from expensive regex operations when url or id is present.

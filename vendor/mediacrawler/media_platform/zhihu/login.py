...
class ZhiHuLogin(AbstractLogin):
    ...
    async def login_by_cookies(self):
        ...
        if cookies:
            ...
            utils.logger.info(f"[ZhiHu.login_by_cookies] Successfully added {len(cookies)} cookies")
        else:
            utils.logger.error("[ZhiHu.login_by_cookies] No cookies found in cookie string")
